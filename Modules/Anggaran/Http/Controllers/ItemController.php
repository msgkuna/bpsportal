...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        ->orderBy('noitem','asc')
        ->paginate(20);
        return view('anggaran::data.item.index',compact('ditem'))
    ...
    {
        return view('anggaran::data.item.upload');
    }
    ...
    public function fileUploadPost(Request $request)
    {
        ...
        if(!is_null($xmlObject->c_item[0])) {
            ...
            return redirect()->route('item.index')->withError('Data pada file '.$UploadfileName.' tidak yang sesuai. Upload data ke database tidak berhasil');
        }
