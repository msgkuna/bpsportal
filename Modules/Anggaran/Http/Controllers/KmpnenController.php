...
class KmpnenController extends Controller
{
    ...
    public function index()
    {
        ...
        ->paginate(20);
        return view('anggaran::data.kmpnen.index',compact('dkmpnen'))
    ...
    {
        return view('anggaran::data.kmpnen.upload');
    }
    ...
    public function fileUploadPost(Request $request)
    {
        ...
        if(!is_null($xmlObject->c_kmpnen[0])) {
            DB::beginTransaction();
            try {
                $data=array();
            ...
            return redirect()->route('kmpnen.index')->withError('Data pada file '.$UploadfileName.' tidak yang sesuai. Upload data ke database tidak berhasil');
        }
    }
}
