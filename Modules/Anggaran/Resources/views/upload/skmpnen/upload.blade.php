...
<div class="container-fluid">
        ...
        <div class="card card-outline card-secondary">
            <div class="card-header">
                <h3 class="card-title">Upload Data Sub Komponen</h3>
                <div class="card-tools">
                    <a class="btn btn-sm btn-success" href="{{ route('skmpnen.index') }}"> Kembali</a>
                </div>
            </div>
            <div class="card-body table-responsive">
				<form action="{{ route('skmpnen.upload.post') }}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
