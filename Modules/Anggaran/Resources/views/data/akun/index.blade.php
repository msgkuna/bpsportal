        ...
        <div class="card card-outline card-secondary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-sm btn-success" href="{{ route('akun.upload') }}"> Upload Data</a>
                </div>
            </div>
                ...
                <table class="table table-hover table-striped table-bordered table-sm table-valign-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="row">{{ $row->bas->nmakun }}</td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="card-footer">
                <div class="float-right d-none d-sm-inline">
                    Menampilkan {{$dakun->count()}} dari {{ $dakun->total() }} data.
                </div>
                {{ $dakun->links() }}
            </div>
        </div>
