...
class PenggunaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pengguna::pengguna.index',compact('pengguna'));
    }
    ...
    public function create(Request $request)
    {
        ...
        ->whereIn('status_id', ['1'])->orderBy('satker_id', 'asc')
                                ...
                                ->paginate(20);
        return view('pengguna::pengguna.create',compact('pegawai'))
    ...
    public function store(Request $request)
    {
        if($request->has('nip')) {
            ...
            return redirect()->route('pengguna.index')->withSuccess('Data telah ditambahkan.');
        } else {
    ...
    public function show($nip)
    {
        ...
        return view('pengguna::pengguna.show', compact('pengguna', 'role'));
    }
